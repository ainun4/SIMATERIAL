package C06.OMG.security.config;
...
import C06.OMG.security.jwtutils.JwtAuthenticationEntryPoint;
import C06.OMG.security.jwtutils.JwtFilter;
    ...
    public class RestApiWebSecurityConfigurationAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http
                    ...
                    .antMatchers("/api/v1/appointment/add").permitAll()
